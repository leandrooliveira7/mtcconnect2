const Header = () => {
  ...
  return (
    <header
      id="header-section"
      className="w-full relative z-[2] bg-black flex flex-col items-center justify-center px-6 py-8 min-h-screen"
    >
      <div className="flex flex-col items-center">
        ...
        <div className="max-w-2xl text-center">
          ...
          <p className="text-white mb-6">
            ...
            Estudantes de Multimédia e Tecnologias da Comunicação que irá criar
            um espaço de interação com diversas empresas da área de CTC
          </p>
